...
// Sets default values
APCylinderActor::APCylinderActor()
{
...
void APCylinderActor::PostLoad()
{
	Super::PostLoad();
	CreateMesh();
}

void APCylinderActor::Tick(float DeltaTime)
{
...
void APCylinderActor::CreateMesh()
{
	int VertexIndex = 0;
	...
	for (int32 QuadIndex = 0; QuadIndex < CrossSectionCount; QuadIndex++)
	{
		...
		Vertices[VertIndex1] = p0; TopCapIndices.Add(VertIndex1);
		Vertices[VertIndex2] = p1; TopCapIndices.Add(VertIndex2);
		Vertices[VertIndex3] = p2; BotCapIndices.Add(VertIndex3);
		Vertices[VertIndex4] = p3; BotCapIndices.Add(VertIndex4);
...
void APCylinderActor::RefreshMesh()
{
	FVector Offset = TopCapPosition;
